...
await page.getByPlaceholder("email@example.com").fill("mohsintahir34052@gmail.com");
await page.getByPlaceholder("enter your passsword").fill("Mohsin34052@");
...
await expect(page.getByText('ZARA COAT 3')).toContainText("ZARA COAT 3");
